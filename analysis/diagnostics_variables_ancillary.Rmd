...
path_cmorized_annual <-
  "/net/kryo/work/loher/ROMS/RECCAP2/SO_d025_global_proto/submit_20211012/"
...
file <- paste(i_variable,
              "_ROMS-SouthernOcean-ETHZ_1_gr_1980-2018_v20211012.nc",
              sep = "")
print(file)
...
for (i_variable in variables) {
  ...
  # read list of all files
  file <- paste(i_variable,
                "_ROMS-SouthernOcean-ETHZ_1_gr_v20211012.nc",
                sep = "")
  print(file)
